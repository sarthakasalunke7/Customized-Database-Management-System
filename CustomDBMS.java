...
class Customized_DBMS
{
    ...
    public Customized_DBMS()
    {
        System.out.println("Custom DBMS started succesfully...");
...
class CustomDBMS
{
    ...
    {
        System.out.println("-------- Custom Database Management System --------");

        Scanner sobj = new Scanner(System.in);

        Customized_DBMS mobj = new Customized_DBMS();
        ...
        while(true)
        {
            ...
            switch(iOption)
            {
                ...
                case 13 : 
                    System.out.println("This project developed by Sarthak");
                    System.out.println("All copyrights reserved..");

                    break;
                    
                case 14 : 
                    System.out.println("Thank you for using the Sarthak's DBMS");
                    mobj = null;
